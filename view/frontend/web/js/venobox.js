        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                function loadVid(autoplay){
                    ...
                    var localAutoplay = 'autoplay loop';
                    var defaultAutoplay = 'allow="autoplay"';
                    var queryvars = stringAutoplay + getUrlParameter(dest);
                    var stringAutoplay = autoplay ? "?rel=0&autoplay=1" : "?rel=0";
                    if(isIOSDevice()){localAutoplay = localAutoplay + ' playsinline muted ';}

                    if (videoObj.type == 'vimeo') {
                      player = 'https://player.vimeo.com/video/';
                      content.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen '+(autoplay ? defaultAutoplay : '')+' frameborder="0" src="'+player+videoObj.id+queryvars+'"></iframe>');
                    } else if (videoObj.type == 'youtube') {
                      player = 'https://www.youtube.com/embed/';
                      content.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen '+(autoplay ? defaultAutoplay : '')+' frameborder="0" src="'+player+videoObj.id+queryvars+'"></iframe>');
                    }
                    
                    content.html('<div class="venoframe vbvid localvideo" style="margin:auto;"><video style="width:100%;" src="' +videoObj.id+ '" ' + localAutoplay + ' controls>Your browser does not support the video tag.</video></div>');
